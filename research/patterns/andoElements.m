...
function [ th ] = th_gaussNdm_f(sort_scores, sort_truth, msort_scores, ...
				msort_model, f1_c, model)
  %% Model
  [ expec, model ] = cluster(CriterionClusterer(Gaussian1D(), BIC(),  ...
						struct("max_k",  10, ...
...
function [ th ] = th_gaussNndm_f(sort_scores, sort_truth, msort_scores, ...
				msort_model, f1_c, model)
  %% Model
  [ expec, model, info ] = ...
      cluster(CriterionClusterer(Gaussian1DNoise(), BIC(), ...
...
th_gaussNm   = struct("name", "GM-N",   "find", @th_gaussNm_f,   ...
		      "basic", false());
th_gaussNdm  = struct("name", "GM-ND",  "find", @th_gaussNdm_f,  ...
		      "basic", false());
th_gaussNnm  = struct("name", "GM-NN",  "find", @th_gaussNnm_f,  ...
		      "basic", false());
th_gaussNndm = struct("name", "GM-NND", "find", @th_gaussNndm_f, ...
		      "basic", false());
...
method_ewocs_bern = ...
    struct("args", 2, ...
	   ...
	   "ths", [ th_best, th_size, th_dist, th_gauss2, th_gauss2n, ...
		    th_gauss2m, th_gauss2nm, th_gaussNm, th_gaussNdm ]);
method_ewocs_hproj = ...
    struct("args", 2, ...
	   "help", "<ensemble_size>, <max_clusters>", ...
	   "make", @(dist, data, s_truth, extra) ...
