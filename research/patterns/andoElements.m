...
%% Threshold sets
ths_nomodel = [ th_all, th_best, th_size ];
...
method_autodgrade = ...
    struct("args", 0, ...
	   ...
	   "make", @(dist, data, struth, extra) ...
	       AutoDGRADE(dist, struct("size_ratio", size_ratio(struth))), ...
	   "scor", false(), ...
	   "xpec", true(), ...
	   "ths",  []);
method_autodgrade_bbc = ...
    struct("args", 0, ...
	   "help", "", ...
	   "make", @(dist, data, struth, extra) ...
	       Pipeline(AutoDGRADE(dist, struct("size_ratio", ...
						size_ratio(struth))), ...
			BBC(dist, struct("size_ratio", ...
					 size_ratio(struth)))), ...
	   "scor", true(), ...
	   "xpec", false(), ...
	   "ths",  ths_simple);
method_autohds = ...
    struct("args", 2, ...
	   ...
	   "make", @(dist, data, struth, extra) ...
	       AutoHDS(dist, ...
		       struct("n_eps", str2double(extra{1}),
			      "n_part", str2double(extra{2}))), ...
	   "scor", true(), ...
	   "xpec", true(), ...
	   "ths",  ths_nomodel);
method_bbocc = ...
...
method_dgrade = ...
    struct("args", 1, ...
	   "help", "<s_one>", ...
	   "make", @(dist, data, struth, extra) ...
	       DGRADE(dist, struct("size_ratio", size_ratio(struth), ...
				   "s_one", str2double(extra{1}))), ...
	   "scor", false(), ...
	   "xpec", true(), ...
	   "ths",  []);
method_ds = ...
...
%% Index
methods = ...
    struct("auto_dgrade",     method_autodgrade, ...
	   "auto_dgrade_bbc", method_autodgrade_bbc, ...
	   "auto_hds",        method_autohds, ...
	   "bbocc",           method_bbocc, ...
	   "bbocc_m",         method_bbocc_m, ...
	   "bbocc_s",         method_bbocc_s, ...
	   "bbcpress",        method_bbcpress, ...
	   "bbcpress_m",      method_bbcpress_m, ...
	   "bbcpress_s",      method_bbcpress_s, ...
	   "dgrade",          method_dgrade, ...
	   "ds",              method_ds, ...
